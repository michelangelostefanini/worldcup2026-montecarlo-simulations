...
|---|---|---:|
| `historical_results.csv` | International results with date, teams, score, competition and neutral-ground flag. The notebook uses `1990-01-01`–`2026-06-10`; older rows remain available for other experiments. Dataset from kaggle.com: "International football results from 1872 to 2026" | 32,287 |
